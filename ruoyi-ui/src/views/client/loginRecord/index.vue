...
<!--          size="mini"-->
<!--          @click="handleAdd"-->
<!--          v-hasPermi="['client:loginRecord:add']"-->
<!--        >新增</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          :disabled="single"-->
<!--          @click="handleUpdate"-->
<!--          v-hasPermi="['client:loginRecord:edit']"-->
<!--        >修改</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          :disabled="multiple"-->
<!--          @click="handleDelete"-->
<!--          v-hasPermi="['client:loginRecord:remove']"-->
<!--        >删除</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          size="mini"-->
<!--          @click="handleExport"-->
<!--          v-hasPermi="['client:loginRecord:export']"-->
<!--        >导出</el-button>-->
<!--      </el-col>-->
...
<!--      </el-table-column>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="登录时间" prop="loginTime" label-width="80px">
          <el-date-picker clearable
